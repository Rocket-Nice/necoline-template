    ...
    <section class="head">
      <div class="container">
        ...
        <div class="head__contacts">
            ...
            <!-- this  -->
            <?php
            $leftRow = get_field('contacts_repeat_left', 'option');
            if ($leftRow) :
            ...
            <!-- this  -->
            <?php
            $rightRow = get_field('contacts_repeat_right', 'option');
            if ($rightRow) :
        ...
        <form action="#" class="form__card card card--primary">
          <div class="form__row">
            ...
            <div class="form__column form__column--flex">
              ...
              <button class="form__button-submit button button--dark title title--button"
