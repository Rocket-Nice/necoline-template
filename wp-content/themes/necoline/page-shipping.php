    ...
    <div class="container">
      ...
      <div class="service-wrapper">
        <aside class="service-wrapper__aside service-aside">
          <nav class="service-wrapper__nav service-aside__nav" data-sticky="1000" data-sticky-top="115"
            data-sticky-bottom="390">
        ...
        <div class="service-wrapper__sections">
          ...
          <section class="directions" id="directions">
            <div class="directions__toggle-buttons toggle-buttons">
			  ...
			  <?php single_term_title(); echo get_the_title(); ?>
			  <?php endforeach; ?>
            <div class="directions__available-services available-services">
              ...
              <div class="available-services__buttons">
                ...
                ?>
                <button class="available-services__button button title title--button"
                  data-direction="aziya-dalnij-vostok<?= $current_language == 'ru' ? '' : '-eng' ?>" data-service-direction="<?php echo str_replace(['-', ' ', '.', '—'], '', get_the_title()); ?>" type="button"><?php the_title() ?></button>
                <?php endwhile; 
                      wp_reset_postdata();
                      endif;
                ?>
                ...
                ?>
                <button class="available-services__button button title title--button" type="button"
                  data-direction="aziya-baltika<?= $current_language == 'ru' ? '' : '-eng' ?>" data-service-direction="<?php echo str_replace(['—','-', ' ', '.'], '', get_the_title()); ?>""><?php the_title() ?></button>
                <?php endwhile; 
                      wp_reset_postdata();
                      endif;
                ?>
...
<picture>
<img class="c-modal__head-image" src="<?php echo get_the_post_thumbnail_url($port->ID); ?>" alt="<?php //the_title(); ?>" data-pagespeed-url-hash=2026520390 onload="pagespeed.CriticalImages.checkImageForCriticality(this);" data-pagespeed-lsc-url="<?php echo get_the_post_thumbnail_url($port->ID); ?>"/>
</picture>
...
<div class="c-modal__lines-travel-label title"><?php $port_direction = get_field('port_direction', $port->ID); echo $port_direction->name; ?></div>
