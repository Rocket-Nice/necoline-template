...
function theme_image($image_name = 'placeholder.png', $print = true, $dir = '/assets/img/') {
	...
	if ( !file_exists($image_path) ) $image_url = get_template_directory_uri() . '/assets/img/error.png';
